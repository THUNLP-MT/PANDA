...
import datetime
from TweetEvalDatasetCoT import TweetEvalDataset
...
def init_logger(args, log_level=logging.INFO):
    ...
    root_output_path = os.path.join(args.output_path, args.task_name, args.mode+'_cot')
...
def main():
    ...
    if args.mode.startswith('learning'):
        ...
        insight_pool = leap_learning(dat, expert_trials, logger=logger)
